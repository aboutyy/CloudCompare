...
QList<QAction *> qMyPlugin::getActions()
{
	...
	if ( !m_action )
	{
		...
		connect( m_action, &QAction::triggered, this, &qMyPlugin::doAction );
	}
...
{	
	...
	m_app->dispToConsole( "[qMyPlugin] Hello world!", ccMainAppInterface::STD_CONSOLE_MESSAGE );
	
	// Display a warning message in the console
	m_app->dispToConsole( "[qMyPlugin] Warning: example plugin shouldn't be used as is", ccMainAppInterface::WRN_CONSOLE_MESSAGE );
	
	// Display an error message in the console AND pop-up an error box
	m_app->dispToConsole( "can we start from here", ccMainAppInterface::ERR_CONSOLE_MESSAGE );
